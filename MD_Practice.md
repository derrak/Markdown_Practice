# Creating a Project Directory and CD Into It
```sh
$ cd Desktop
$ mkdir hello-world
$ cd hello-world
...
$ git init
```
# Create and edit the HTML file within PWD
```sh
...
$ git add .
```
# Commit your work to the project history
```sh
...
```sh
$ git remote add [project nickname] https://github.com/ada-lovelace/hello-world
```
# Push code to the GitHub server
```sh
$ git push [project nickname] main
```
`
`
`
